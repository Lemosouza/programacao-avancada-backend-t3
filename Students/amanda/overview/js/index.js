...
//Dúvida no conceito de array, no modo como usar let e const
...
function calcular() {
    ...
    document.getElementById('resultado').value = resultado.toFixed(2); // A função toFixed(2) limita o resultado a duas casas decimais
  }
...
function calculadora(num1, num2) {
  ...
  const resultados = calculadora(10, 5);
